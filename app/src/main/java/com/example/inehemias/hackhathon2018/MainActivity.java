...
public class MainActivity extends AppCompatActivity implements Button.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyBroadCastReceiver myReciever = new MyBroadCastReceiver();
        android.content.IntentFilter intentFilter = new android.content.IntentFilter();
        intentFilter.addAction("com.example.Secure");
    ...
    private void openDialog(){
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                ci.feed = subEditText.getText().toString() +" Donated "+amount + " to "+company;
    ...
    public void generateUsers(){
        ContactInfo currUser;
        String [] names = getResources().getStringArray(R.array.names);
        String [] surnames = getResources().getStringArray(R.array.lastnames);


        for(int i=0; i<names.length; ++i){
           currUser= new ContactInfo(surnames[i],names[i], "donated "+amount*2);
           list.add(currUser);
    ...
    public void donate_activity(View view) {
